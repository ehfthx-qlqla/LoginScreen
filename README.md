...
![과제3 실행화면](img/visiblebutton.png)
![과제3 실행화면](img/whenvisiblebutton.png)

- 과제내용
 - Enter키를 치면 로그인 되도록 포커스 흐름 정리
 - ▶ 아이디 입력하고 à Enter키 치면 패스워드 입력 창으로 넘어가기
 - ▶ 패스워드 입력하고 à Enter키 치면 로그인 시작하기
...
- 구현내용과기능설명
 - 네이버 로그인창을 참고하여 텍스트박스 오른쪽 x표시를 클릭했을 때 내용이 삭제되고, 다시 포커싱되도록 구현하였습니다.
 - 패스워드 입력창 오른쪽 '눈 기호'를 클릭했을 때 비밀번호가 표시되고, 다시 클릭했을 때 비밀번호가 '●'로 표시되도록 구현하였습니다.